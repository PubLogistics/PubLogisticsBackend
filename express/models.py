...
class Package(models.Model):
    ...
    addresser=models.ForeignKey(UserProfile,on_delete=models.DO_NOTHING,related_name="addresser",verbose_name="发件人")
    addressee=models.ForeignKey(UserProfile,on_delete=models.DO_NOTHING,related_name="addressee",verbose_name="收件人")
